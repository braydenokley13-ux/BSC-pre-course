...
export const CONCEPT_CARDS: ConceptCard[] = [
  ...
  },
  {
    ...
    termIds: ["trade-matching-rule", "salary-aggregation", "second-apron"],
  ...
  },
  {
    ...
    termIds: ["net-rating", "true-shooting", "bpm", "sample-size", "dollar-per-win-share"],
  ...
  },
  {
    ...
    termIds: ["load-management", "minute-load", "injury-risk", "availability"],
