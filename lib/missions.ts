...
const capCrunch: Mission = {
  ...
  scenario:
    "Your team point guard, Marcus Webb, has one year left on his deal and has made two All-Star teams. His agent is demanding a 3-year, $48M extension — which pushes your $168M payroll $14M over the luxury tax line. LA and Miami have cleared cap space. Webb's agent wants an answer in 48 hours.",
  ...
  infoCards: [
    {
      ...
      content:
        "Current payroll: $168M. Luxury tax line: $171M. You're $3M under. Signing a 3yr/$48M extension moves you to $185M — $14M over. First-year penalty: ~$6.3M on top of salary. Repeater line applies if you're over the tax in 3 of the next 4 seasons.",
      revealDelay: 0,
    },
    {
  ...
  roles: [
    ...
    },
    {
      ...
      privateInfo:
        "The owner told you privately: the absolute hard ceiling is $180M total payroll — $9M over tax. At $185M you are $5M above what he'll actually authorize. He said 'luxury tax is fine once' but he meant under $180M. You need to talk Webb down.",
    },
    {
      id: "scout",
      title: "HEAD SCOUT",
      ...
      privateInfo:
        "Webb's heel stress reaction 18 months ago was worse than reported. The team doctor gave him a 28% re-injury chance over 3 years. He's also quietly showing early signs of over-reliance on his left hand after favoring his right foot. You're not sure he's worth $16M/year in Year 3.",
    },
    {
      id: "marketing",
      title: "MARKETING DIR",
      ...
      privateInfo:
        "Webb's jersey is #2 in the city behind only the team legend. Losing him projects to a 22% drop in merch revenue — about $4.1M annually. Our top jersey sponsor has a performance clause tied to a marquee star being on the roster. If Webb leaves, that clause triggers and we lose $2.8M in sponsor revenue.",
    },
  ],
  ...
  rounds: [
      ...
      options: [
        {
          ...
          description: "Commit fully — 3yr/$48M, lock up the team cornerstone. Accept the luxury tax bill.",
    ...
    {
      id: "terms-sign",
      prompt: "Webb's agent responds right away: 'Deal. But he wants a no-trade clause and a player option in Year 3.'",
      ...
      options: [
        ...
        },
        {
          ...
          description: "Protect the star, keep contract certainty. Talk hard on the player option.",
    ...
    },
    {
      ...
      context: "Playoff team A (LA): 2 unprotected first-round picks + a young PG on a rookie deal. Playoff team B (Miami): 1 unprotected first + their starting center (2 years, $18M remaining).",
      dependsOnRoundId: "direction",
      ...
      options: [
        ...
        },
        {
          ...
          description: "Stay semi-strong. Keep a playoff-caliber roster piece while shedding Webb's extension.",
          tags: ["accept-miami", "balanced"],
        },
        {
          id: "reject-trades",
          label: "Reject both — keep Webb",
          description: "Neither package is good enough. Go back to the extension talks.",
  ...
  rivalCounter: {
    ...
    message:
      "COMMISSIONER ALERT: The NBA Board of Governors voted 24–6 to strengthen the Second Apron rules. Teams entering the repeater luxury tax line in Year 2+ of a new CBA cycle face an extra 15% surtax. Your current path puts you in repeater range by Year 3. Does this change your approach?",
    responseRound: {
      id: "rival-response",
  ...
  outcomes: [
    ...
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 5,
          narrative:
            "He accepted — then let it slip to two teammates that the team office 'lowballed him.' The locker room notices. He's performing, but the trust gap with the team is real.",
      ...
      variants: [
        {
          ...
          scoreΔ: 6,
          narrative:
            "Two unprotected firsts in your vault. Webb went to LA and right away posted 31 points in his debut. The city is angry. The picks are real assets. In three years you'll know if this was genius or cowardice.",
    ...
    },
    {
      ...
      variants: [
        {
          probability: 0.65,
          label: "Trade Accepted — Strong Pivot",
          scoreΔ: 8,
          narrative:
    ...
    variants: [
      {
        ...
        scoreΔ: 5,
        narrative:
          "The team office made a call under pressure and moved forward. Results are pending.",
        applyStatus: [],
      },
    ],
  },
...
const contractChoice: Mission = {
  ...
  infoCards: [
    {
      title: "SUPERMAX RULES CONFIRMED",
      content:
  ...
  roles: [
    ...
    },
    {
      ...
      privateInfo:
        "Our model has Cole at a 94th percentile RAPTOR forecast through age 27, dropping to 80th percentile by 29. The model values him at $43.2M/year through his prime and $31M/year in post-prime. The supermax pays him $47.6M/year. By our calculation, you're paying $4.4M/year above market from Day 1 and $16.6M/year above market by Year 5.",
    },
  ],
  ...
  rounds: [
    {
      ...
      options: [
        {
          id: "offer-supermax",
          label: "Offer the full Supermax right away",
          description: "35% of cap, 5 years, fully guaranteed. Highest commitment to your team cornerstone.",
          ...
          mutations: [
            {
              ...
              descriptionPrefix: "Your rebuild order makes this the logical choice — assets now over commitment. ",
            },
            {
  ...
  outcomes: [
    {
      ...
      variants: [
        {
          probability: 0.70,
          label: "Team Locked In — Full Commitment",
          scoreΔ: 9,
          narrative:
      ...
      variants: [
        {
          ...
          scoreΔ: 9,
          narrative:
            "Cole signed. The Year 5 option is cosmetic — he'll be 29 and you'll likely talk a new deal by then anyway. You got the star, the commitment, and reasonable flexibility. Best outcome.",
          applyStatus: ["star-retained"],
        },
        {
          probability: 0.25,
      ...
      variants: [
        {
          ...
          scoreΔ: 8,
          narrative:
            "Both sides gave something. Cole gets $43M/year — above team-friendly, below supermax. He's satisfied. You saved $24M in total commitment vs. the full supermax. The locker room sees a team willing to invest.",
          applyStatus: ["star-retained"],
        },
        {
          probability: 0.35,
          ...
          scoreΔ: 5,
          narrative:
            "He signed but told a reporter the team office 'prioritized the budget over the player.' It's a distraction. He performs but the team trust is fractured.",
          applyStatus: ["star-retained", "coach-conflict"],
        },
      ],
    },
      ...
      variants: [
        {
          ...
          scoreΔ: 6,
          narrative:
            "Two unprotected firsts. Houston celebrates, your city mourns. Cole right away becomes the face of Houston's team. In 3 years, you'll know if those picks were worth it.",
          applyStatus: ["rebuild-mode", "trade-assets-rich"],
        },
      ],
    },
      ...
      variants: [
        {
          ...
          scoreΔ: 8,
          narrative:
            "Two firsts, a future first, and a solid wing. You stayed strong while building for the future. The wing fits your system. This is how you thread the needle between rebuild and contention.",
          applyStatus: ["trade-assets-rich"],
        },
        {
          probability: 0.40,
    ...
    variants: [
      {
        ...
        label: "Decision Made",
        scoreΔ: 5,
        narrative: "A decision was reached under pressure. The team moves forward.",
        applyStatus: [],
      },
    ],
  },
...
const revenueMix: Mission = {
  ...
  infoCards: [
    {
      ...
      content:
        "BRI (Basketball-Related Income) covers gate receipts, local media, sponsorships, and merchandise. The current CBA splits BRI 50/50 between players and owners. Local sponsorship revenue above a baseline line is shared via the revenue distribution pool — about $0.50 of every incremental dollar goes to smaller-market teams. Net local value to your team: ~$12.5M/year of the $25M face value.",
      revealDelay: 0,
    },
    {
      ...
      options: [
        {
          ...
          description: "Highest guaranteed revenue. Close fast before they look elsewhere. Deal with the player concerns internally.",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          description: "Work with the players individually. If a player has a competing brand deal, we carve them out of the social order.",
          tags: ["offer-exemptions", "player-friendly"],
        },
        {
          id: "renegotiate-social",
          label: "Go back to NovaTech — reduce social posts to 6, same price",
          description: "Use the conflict issue as power to soften the order. Keep the $25M.",
  ...
  rivalCounter: {
    ...
    message:
      "COMPETITOR ALERT: Boston just announced a 5-year, $30M/year jersey patch deal with a rival tech company — the new league record. Your NovaTech deal, at $25M or $22M, is no longer the largest in team history. The owner is calling. He wants to know why you didn't push for more.",
    responseRound: {
      id: "rival-response",
      ...
      options: [
        ...
        },
        {
          ...
          description: "Tell the owner the number isn't everything. Steady culture drives long-term revenue better than a headline figure.",
  ...
  outcomes: [
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 4,
          narrative:
            "Your starting center's competing brand deal creates a legal dispute. His agent threatens breach-of-contract action against the team. It resolves in 90 days, but the distraction during the season is damaging. The BRI revenue net is $12.5M/year — not the $25M headline.",
    ...
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 5,
          narrative:
            "$15M/year — NovaTech's board flagged it as below-market within 18 months. They triggered an exit clause in Year 3. You're back to zero sponsorship revenue with one year of experience talking bad deal terms.",
          applyStatus: [],
        },
      ],
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 5,
          narrative:
            "The base held at $18M. But the $5M upside trigger required a playoff appearance — you finished 9th. NovaTech's board circled the clause and brought it up in Year 2 negotiations. Revenue is below forecast.",
          applyStatus: [],
        },
      ],
    },
    ...
    variants: [
      {
        ...
        label: "Deal Decided",
        scoreΔ: 5,
        narrative: "A revenue decision was made under complex conditions. The team moves forward.",
        applyStatus: [],
      },
    ],
  },
  ...
  roles: [
    {
      id: "capologist",
      title: "CAPOLOGIST",
      description: "You are the power on CBA trade mechanics and cap exposure.",
      privateInfo:
        "Here's the number nobody's saying out loud: if we cross the Second Apron line, we lose aggregation rights for 3 years. That means every future trade, we can only send one contract to match salary. If we plan to be buyers at future deadlines, crossing the Second Apron today handicaps us far beyond just this deal. The short-term gain has a very long tail of restrictions.",
    },
    {
      id: "president",
      title: "TEAM PRESIDENT",
      description: "You balance win-now pressure with long-term team health.",
      privateInfo:
    ...
    },
    {
      ...
      privateInfo:
        "Our playoff chance model: current roster at 34% chance to make the play-in, 12% to advance past the first round. With Reeves added: 71% play-in, 38% first-round advance. The value is big. But here's the model's other output: Reeves as a free agent this summer projects to receive a 4yr/$108M offer — we cannot afford that if we're over the Second Apron. We get him for 60 regular season games and a playoff run, then lose him for free to cap-space teams. Run the math on whether that's worth 3 years of restricted trade flexibility.",
    },
  ],
  ...
  rivalCounter: {
    ...
    responseRound: {
      ...
      options: [
        {
          id: "accelerate",
          label: "Speed up — file the paperwork now",
      ...
      variants: [
        {
          ...
          scoreΔ: 9,
          narrative:
            "Dallas took back a $4M expiring deal to reduce the net salary increase. You landed under the Second Apron. Reeves came, the team made the playoffs, and your trade flexibility is preserved. Best core outcome on this path.",
          applyStatus: [],
        },
        {
          probability: 0.35,
    ...
    variants: [
      {
        ...
        scoreΔ: 5,
        narrative: "The deadline passed. The team office made a call.",
        applyStatus: [],
      },
    ],
  },
...
const statsLineup: Mission = {
  ...
  scenario:
    "Your stats team has identified a five-man bench lineup with a +12.4 net rating over 214 possessions this season — the third-best lineup combination in the entire league by this measure. Your starting five's net rating over the same period: +3.1. The gap is not noise. But your head coach, Marcus Hill — a 22-year veteran with two championship rings — calls advanced metrics 'box score fiction invented by people who never laced up.' He has the locker room's trust. You control the team office. Someone has to give.",
  scenarioInjections: [
    {
  ...
  infoCards: [
    {
      ...
      content:
        "Bench lineup: Watts / Torres / Bell / Reyes / Crawford. Net rating: +12.4 per 100 possessions over 214 possessions. Offensive rating: 119.8 (league rank: 2nd). Defensive rating: 107.4 (league rank: 8th). Starting lineup net rating same period: +3.1. Model confidence: 94%. Sample size is statistically big — this is not a small-sample anomaly.",
      revealDelay: 0,
    },
    {
  ...
  roles: [
    ...
    },
    {
      ...
      description: "You're the team office decision-maker. The coach works for you — technically.",
      privateInfo:
        "Coach Hill has 2 years left on his contract at $8M/year. If you override him and he resigns, you owe him $16M. If you fire him without cause, same $16M. The relationship with this coach is also a free agent selling point — two veterans signed here specifically because Hill was the coach. The stats decision is also a personnel decision.",
    },
    {
      id: "president",
      title: "TEAM PRESIDENT",
      description: "You manage the owner relationship and team culture.",
      privateInfo:
    ...
    },
    {
      ...
      privateInfo:
        "I've been in locker rooms for 18 years. When the team office overrides the coaching staff on rotations, players don't see it as stats-forward — they see it as chaos. Three veterans have told me privately they'd put 'team steadiness' on a list of reasons to stay or leave in free agency. Coach Hill's trust with the roster is a real asset. If you undermine him on something as visible as rotations, you're trading his power for a lineup edge.",
    },
  ],
  ...
  rounds: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          description: "Build a bridge between the stats department and coaching staff without creating a power conflict.",
    ...
    {
      id: "terms-mandate",
      prompt: "Coach Hill hears the directive. He calls a player meeting without telling you. Three starters emerge from the meeting and ask for a conversation with the team office.",
      context: "The order triggered a locker room response. The players want to be heard.",
      dependsOnRoundId: "direction",
      ...
      options: [
        {
          ...
          description: "Transparency over power. Show them the numbers. Earn their buy-in.",
          tags: ["meet-players", "transparent"],
        },
        {
          id: "hold-directive",
          label: "Hold the directive — Coach Hill implements or he's reassigned",
          description: "The team office decision stands. No talks with the roster over rotations.",
          tags: ["hold-directive", "authority"],
        },
        {
          id: "pull-back-mandate",
          label: "Pull back the order — revert to collaborative approach",
          description: "The blowback is too big. Walk it back and restart the conversation with Coach Hill.",
    ...
    {
      id: "terms-bridge",
      prompt: "You've hired Dr. Keisha Morgan, a data scientist with 8 years of coaching experience. She meets with Coach Hill. He accepts her — but wants her role limited to 'consultation only, no rotation power.'",
      context: "The bridge hire is in place. Now define the power structure.",
      dependsOnRoundId: "direction",
      ...
      options: [
        ...
        {
          id: "joint-authority",
          label: "Define joint power — Morgan + Hill sign off on lineup decisions",
    ...
    responseRound: {
      ...
      options: [
        ...
        },
        {
          ...
          description: "If he defends the analytical approach, it lands with more trust than you saying it.",
  ...
  outcomes: [
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 3,
          narrative:
            "Finished 3 games below .500. The stats team ran the counterfactual: the bench lineup, used properly, projects to 5-6 extra wins. That's the difference between a lottery pick and a playoff run. The data was right. You didn't act on it.",
          applyStatus: ["coach-conflict"],
        },
      ],
    },
      ...
      variants: [
        {
          ...
          scoreΔ: 9,
          narrative:
            "Two weeks, 8 minutes per game. The bench lineup went +16 net rating in live action against 6 opponents. Coach Hill called a staff meeting. 'I've been coaching this wrong.' By February it was a core rotation. Best of both worlds — his buy-in made it steady.",
        ...
        },
        {
          ...
          scoreΔ: 5,
          narrative:
            "The pilot ran against three elite defenses. The net rating dropped to +2.1. Coach Hill called it right away: 'I told you.' He's not wrong — the sample hit bad luck and tough opponents. The data is still right structurally, but you've lost the argument for now.",
          applyStatus: ["coach-conflict"],
        },
      ],
    },
    ...
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 2,
          narrative:
            "He walked out in February. The assistant coach finished the season. The locker room fractured. Three free agents cited 'team instability' as a reason to look elsewhere in the summer. The lineup numbers were right. The approach was wrong.",
      ...
      variants: [
        {
          ...
          scoreΔ: 7,
          narrative:
            "The data meeting with players went well. The starting SF said: 'I didn't know the numbers were that big.' Rotations adjusted. Coach Hill implemented reluctantly but professionally. The lineup produced. The relationship with the coach is strained but functional.",
        ...
        },
        {
          ...
          scoreΔ: 3,
          narrative:
            "Coach Hill resigned the week after the player meeting. He told the press: 'The team office doesn't trust its coaches.' Three veteran players requested trade conversations. You implemented the lineup without the coach who built the culture around it.",
          applyStatus: ["coach-conflict", "rebuild-mode"],
        },
      ],
    },
      ...
      variants: [
        {
          ...
          scoreΔ: 7,
          narrative:
            "Coach Hill implemented the rotation. Barely. The locker room saw the tension. Results were positive on the floor. Two veterans opted out of extensions citing 'team office interference in basketball decisions.' The lineup worked. The culture cost was real.",
        ...
        },
        {
          ...
          scoreΔ: 2,
          narrative:
            "He was gone within the week. The team went 6-14 under the interim coach while absorbing the roster disruption. The stats were right. The execution destroyed the season.",
          applyStatus: ["coach-conflict", "rebuild-mode"],
        },
      ],
    },
      ...
      variants: [
        {
          ...
          scoreΔ: 7,
          narrative:
            "Dr. Morgan spent three months earning Coach Hill's trust. By mid-season she was in every staff meeting. The bench lineup was deployed in 60% of games by February. Steady, collaborative, and nobody quit. Sometimes the slow path is the right path.",
          applyStatus: ["analytics-forward"],
        },
        {
          probability: 0.30,
          ...
          scoreΔ: 5,
          narrative:
            "Consultation only meant consultation ignored. Coach Hill appreciated Dr. Morgan personally but changed almost nothing. The bench lineup got 3 minutes per game. Good hire, wrong power structure.",
          applyStatus: [],
        },
      ],
    },
  ...
  infoCards: [
    {
      ...
      content:
        "Team doctor Dr. Patel report: Morris is showing grade-1 plantar fasciitis indicators in both feet — common in high-minute players at this point in the season. Not a current injury. Estimated re-injury escalation risk if minutes remain at 38+: 34% chance of soft tissue strain before the end of the regular season. Recommended: reduce to 32-34 minutes per game right away. Alternative: full rest for 4-5 games, then managed return.",
      revealDelay: 0,
    },
    {
  ...
  roles: [
    {
      ...
      privateInfo:
        "Plantar fasciitis that progresses from grade-1 to grade-2 during a playoff run is a career-altering injury, not a game-to-game issue. I've seen two team players miss entire playoff runs to this exact injury pathway. My recommendation is 32 minutes max and no back-to-backs. I cannot force this — but I can tell you the medical risk with complete clarity: at 38+ minutes per game, we are rolling the dice every night.",
    },
    {
      id: "coach",
      title: "HEAD COACH",
    ...
    },
    {
      id: "president",
      title: "TEAM PRESIDENT",
      description: "You balance team risk, player relations, and ownership expectations.",
      privateInfo:
    ...
    },
    {
      ...
      privateInfo:
        "I've run the numbers both ways. At 38 min/game: 71% playoff appearance chance, but 34% injury-before-playoffs chance. Expected playoff wins at full health: 2.8 rounds. Expected playoff wins accounting for injury risk: 1.4 rounds. At 32 min/game: 58% playoff appearance chance, 94% arrive-healthy chance. Expected playoff wins: 2.4 rounds. The math slightly favors load management — but it's close enough that it genuinely depends on values, not just chance.",
    },
  ],
  ...
  rounds: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          description: "Highest protection. Absorb the record hit now, arrive at playoffs completely healthy.",
      ...
      options: [
        {
          ...
          description: "Take it off the coach's back. Team office owns the decision publicly.",
    ...
    },
    {
      ...
      options: [
        {
          id: "shut-down-now",
          label: "Shut him down right away — playoffs are all that matters",
        ...
        },
        {
          ...
          label: "Game-time decisions — Morris and doctor decide each night",
    ...
    responseRound: {
      ...
      options: [
        ...
        },
        {
          ...
          description: "Let the coach handle the public question. Takes pressure off the team office.",
      ...
      variants: [
        {
          ...
          scoreΔ: 8,
          narrative:
            "Coach Hill averaged Morris at 33.4 minutes over the last 11 games. Sat him both back-to-backs. Maintained the 4th seed. Morris entered the playoffs at 96% health by doctor assessment. The flexibility gave the coach power and produced the right outcome.",
          applyStatus: ["high-morale"],
        },
        {
          probability: 0.40,
      ...
      variants: [
        {
          ...
          scoreΔ: 7,
          narrative:
            "The grade-2 diagnosis was the wake-up call. Three games rest before the playoffs. Morris arrived at 91% — not 100%, but stable. First-round win. The injury scare changed the team's approach to load management for good.",
          applyStatus: [],
        },
        {
          probability: 0.30,
      ...
      variants: [
        {
          ...
          scoreΔ: 5,
          narrative:
            "He played through it. Grade-2 held. Made it to the playoffs. Won the first round. The medial doctor was right about the risk — you got lucky. Morris knows what he put his body through. This conversation will come up in every future contract talks.",
          applyStatus: [],
        },
        {
          probability: 0.70,
          ...
          scoreΔ: 1,
          narrative:
            "Game 9. Routine drive to the basket — he went down. Plantar fascia rupture. Season over. The medical team's risk assessment was accurate: 34% regular season injury chance given continued high minutes. You were in that 34%.",
    ...
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 3,
          narrative:
            "The 5-game absence cost more seeds than expected. Team finished 9th — out of the play-in. Morris was 100% healthy for a lottery finish. The medical decision was correct. The timing was catastrophic.",
          applyStatus: [],
        },
      ],
    },
    ...
    variants: [
      {
        ...
        label: "Decision Made",
        scoreΔ: 5,
        narrative: "The team office made a health management call. Results follow.",
        applyStatus: [],
      },
    ],
  },
...
const draftTable: Mission = {
  ...
  roles: [
    ...
    },
    {
      id: "analytics",
      title: "ANALYTICS LEAD",
      description: "You built the player forecast model. You understand what the data says.",
      privateInfo:
    ...
    },
    {
      id: "president",
      title: "TEAM PRESIDENT",
      description: "You interface with ownership and manage the team's long-term direction.",
      privateInfo:
        "The owner told me before the draft: 'I want a player the fans will love. I don't want another rotation player.' That rules out the safe ceiling of Mateo Silva in his mind. He's read about Cole — the stats darling narrative. He wants the bold pick. But if Cole is a bust, the owner's instinct will be to blame the stats team, not himself. That's the political reality. The bold pick needs to be the right bold pick.",
    },
  ],
      ...
      variants: [
        {
          ...
          scoreΔ: 7,
          narrative:
            "Year 1: 11 points, 4 rebounds, solid defense. Year 2: earned a starting spot. Year 3: 15 points, 2nd-team All-Defense. Exactly what the scouts expected. Cole went #9 — averaged 22 in Year 3 and made the All-Star team. The safe pick was good. The model was also right.",
    ...
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 4,
          narrative:
            "The shot chart issue wasn't fixable. The right-wing jumper never developed. He's a solid 16-ppg player — not a bust, not a star. The scouts' range of outcomes was more accurate than the model's top-15 forecast. Silva, taken at #9 by Memphis, made his first All-Star game in Year 3.",
          applyStatus: [],
        },
      ],
    },
    ...
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 5,
          narrative:
            "Portland took Cole at #10. You ended up with your best available at 12 — a solid pick, not a star. Memphis first is still in the vault. You got two solid assets for the price of giving up a potential team pick.",
          applyStatus: ["trade-assets-rich"],
        },
      ],
    },
...
const finalGmCall: Mission = {
  ...
  roles: [
    {
      ...
      privateInfo:
        "Here's what I know that the owner doesn't: my job security is directly tied to Year 1 performance, not Year 3. If I pitch a rebuild, I'm likely gone in Year 2 when we're at the bottom of the standings — even if the rebuild is the right call. My incentive is to pitch 'win now' even if the long-term answer is patience. I need to be honest with myself about whether my plan serves the team or my contract.",
    },
    {
      id: "president",
      title: "TEAM PRESIDENT",
  ...
  rounds: [
      ...
      options: [
        {
          ...
          description: "Trade picks for veterans? No. Build through the draft, clear bad contracts, let the young core lead. Strong by Year 3.",
        ...
        },
        {
          ...
          mutations: [
            ...
            },
            {
              ...
              descriptionPrefix: "Your stats culture is already in place. This path is the fullest expression of everything you've built. ",
            },
          ],
        },
        {
          ...
          mutations: [
            {
              ...
              descriptionPrefix: "WARNING: You're already over the luxury tax. Going all-in means crossing into Second Apron territory — you lose future trade flexibility for good. ",
            },
            {
              ifStatus: "star-retained",
        ...
        },
        {
          ...
          label: "Full stats transformation — rebuild decision-making from the ground up",
          ...
          mutations: [
            ...
            },
            {
              ...
              descriptionPrefix: "NOTE: A full stats transformation will require resolving the coaching friction first. The two visions are incompatible. ",
            },
          ],
        },
      ],
    ...
    {
      id: "terms-rebuild",
      prompt: "The owner responds: 'A rebuild means Webb walks when his contract is up. He's the face of this team. How do you retain him or replace him?' The president flags: the supermax extension window closes in 60 days.",
      ...
      options: [
        ...
        {
          id: "let-window-close",
          label: "Let the extension window close — talk as a free agent",
          description: "No supermax. Talk a market deal when he's a free agent. Retain cap flexibility.",
    ...
    {
      id: "terms-hybrid",
      prompt: "The owner asks: 'What does the stats investment look like specifically? Are we replacing scouts or adding to them?' You need to define the model.",
      context: "The hybrid vision requires defining the team structure.",
      dependsOnRoundId: "direction",
      ...
      options: [
        ...
        },
        {
          ...
          description: "Model makes the call. Scouts add human nuance. Stats leads all major decisions.",
          tags: ["analytics-primary", "data-driven"],
        },
        {
          id: "scouts-primary",
          label: "Scouts as primary — stats as verification",
          description: "Classic evaluation leads. Stats validates or challenges. Human judgement at the center.",
    ...
    {
      id: "terms-win-now",
      prompt: "The capologist flags: trading both picks + pursuing a max free agent puts you over the Second Apron in Year 1. You lose aggregation rights for 3 years. The stats lead's model shows a 31% playoff chance by Year 3 on this path.",
      context: "The win-now vision has serious long-term core costs.",
      dependsOnRoundId: "direction",
  ...
  rivalCounter: {
    ...
    message:
      "LEAGUE NEWS: Boston just completed a blockbuster sign-and-trade, landing a second max player — their core is locked for 5 years. Three other top-8 teams have made big off-season moves. Your local beat reporter publishes: 'While rivals improve, [Your Team] is still searching for a three-year direction.' The owner forwards you the article with one word: 'Respond.'",
    responseRound: {
      id: "rival-response",
      ...
      options: [
        {
          id: "accelerate-plan",
          label: "Speed up the plan — announce a major move to change the narrative",
        ...
        {
          id: "stay-the-course",
          label: "Stay the course — say the plan clearly and resist pressure",
          description: "Knee-jerk decisions are how you end up with bad contracts. Trust the three-year vision.",
          tags: ["stay-the-course", "disciplined"],
        },
        {
          id: "owner-press-conference",
          label: "Have the owner speak — team steadiness message",
          description: "The owner publicly endorses the plan. Team office trust is re-established via his power.",
  ...
  outcomes: [
    {
      ...
      variants: [
        ...
        {
          probability: 0.35,
          label: "Rebuild — Slower Than Expected",
          scoreΔ: 4,
          narrative:
      ...
      variants: [
        {
          ...
          scoreΔ: 8,
          narrative:
            "Extended Webb before the window closed. Built around him — stats-sourced picks, cost-controlled talent. Year 3: playoff team with Webb as the veteran anchor and two young stars around him. Best of both worlds.",
        ...
        },
        {
          ...
          scoreΔ: 5,
          narrative:
            "Extended Webb but the picks didn't hit. He's unhappy playing on a non-strong team. Year 3: he's requesting a trade. The supermax extension becomes a trade asset, not a cornerstone.",
          applyStatus: ["star-retained", "coach-conflict"],
        },
      ],
    },
    {
      ...
      variants: [
        {
          probability: 0.75,
          label: "Hybrid Model — Steady Contention",
          scoreΔ: 10,
          narrative:
            "The dual-power structure created productive friction. Stats found two overlooked players. Scouts validated them. Webb was extended and anchored the system. Year 3: 2nd seed in the conference. Two analytically-sourced All-Stars. Zero wasted contracts. This is what a well-run team looks like.",
        ...
        },
        {
          ...
          scoreΔ: 6,
          narrative:
            "Parallel power created paralysis on two key decisions — both scouts and stats disagreed on the same player, and no one had the power to decide. Missed a deadline. Lost a free agent. Year 3: strong but underachieving for the talent assembled.",
          applyStatus: ["analytics-forward"],
        },
      ],
    },
    {
      ...
      variants: [
        {
          probability: 0.70,
          label: "Stats-Primary — Clear Decision Structure",
          scoreΔ: 9,
          narrative:
            "Clear power made decisions fast. The model identified two All-Star caliber players that scouts had underrated. Year 3: most efficient offense in the league. Webb extended. Young core flourishing. The scouts who stayed became the model's best critics — the tension made both sides better.",
          applyStatus: ["analytics-forward", "high-morale"],
        },
        {
          probability: 0.30,
    ...
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 2,
          narrative:
            "Year 1: picked up, got to the second round, lost. Year 2: Webb aged, the max free agent slipped, and you had no picks to retool. Year 3: lottery team with a $180M payroll and Second Apron restrictions. No exit.",
    ...
    },
    {
      ...
      variants: [
        {
          probability: 0.60,
          label: "Modified Win-Now — Steady Pressure",
          scoreΔ: 7,
          narrative:
            "Traded one pick, kept the other. Stayed off the Second Apron. Missed on the max free agent but signed a quality $20M player. Year 1: 5th seed. Year 3: still strong with one pick remaining and manageable cap. Not a championship run — a durable playoff team.",
          applyStatus: [],
        },
        {
          probability: 0.40,
    ...
    },
    {
      ...
      variants: [
        {
          probability: 0.55,
          label: "Stats-Forward — Three-Year Build",
          scoreΔ: 8,
          narrative:
            "Invested $4M in stats systems. Replaced two classic scouts with data scientists. The model found three overlooked players other teams passed on. Year 3: most efficient offense in the league. Webb happy, young core thriving. The scouts who remained became the model's best critics.",
          applyStatus: ["analytics-forward", "high-morale"],
        },
        {
          probability: 0.45,
          ...
          scoreΔ: 4,
          narrative:
            "The transformation was too fast. Half the scouting staff resigned in protest. The model performed — but lost the human layer that scouts provide. Two analytically-sourced picks had undisclosed character concerns that the model couldn't flag. Year 3: rebuilding again.",
          applyStatus: ["analytics-forward", "coach-conflict"],
        },
      ],
    },
    ...
    variants: [
      {
        ...
        scoreΔ: 6,
        narrative:
          "The three-year plan was presented. The owner approved. The team moves forward with a defined plan.",
        applyStatus: [],
      },
    ],
  },
