    ...
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 5,
          narrative:
            "He accepted. then let it slip to two teammates that the front office 'lowballed him.' The locker room notices. He's performing, but the trust gap with the team is real.",
...
const revenueMix: Mission = {
  ...
  scenarioInjections: [
    ...
    {
      requiredStatus: "rebuild-mode",
      prependText: "You're in rebuild mode. Revenue stability is now very serious. your payroll is shrinking but your operating costs aren't. A bad deal here could set the team back years.",
    },
    {
...
const expensePressure: Mission = {
  ...
  scenarioInjections: [
    ...
    {
      requiredStatus: "star-retained",
      prependText: "With Webb locked in, Reeves would give you a true two-man front office story to sell to free agents. The combination could push you from fringe playoff team to genuine threat.",
    },
  ],
  ...
  roles: [
    ...
    },
    {
      ...
      privateInfo:
        "Our playoff probability model. current roster at 34% chance to make the play-in, 12% to advance past the first round. With Reeves added. 71% play-in, 38% first-round advance. The value is big. But here's the model's other output. Reeves as a free agent this summer projects to receive a 4yr/$108M offer. we cannot afford that if we're over the Second Apron. We get him for 60 regular season games and a playoff run, then lose him for free to cap-space teams. Run the math on whether that's worth 3 years of restricted trade flexibility.",
    },
  ],
...
const statsLineup: Mission = {
  ...
  scenarioInjections: [
    {
      ...
      prependText: "You've already committed to analytics culture in this team. This decision will determine whether that commitment holds under pressure. or collapses when it gets hard.",
    },
    {
  ...
  roles: [
    ...
    },
    {
      ...
      privateInfo:
        "I've been in locker rooms for 18 years. When the front office overrides the coaching staff on rotations, players don't see it as analytics-forward. they see it as chaos. Three veterans have told me privately they'd put 'organizational stability' on a list of reasons to stay or leave in free agency. Coach Hill's trust with the roster is a real asset. If you undermine him on something as visible as rotations, you're trading his power for a lineup edge.",
    },
  ],
  ...
  rounds: [
    {
      ...
      options: [
        ...
        {
          id: "mandate-changes",
          label: "Order the lineup change from the front office",
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          description: "The front office decision stands. No talks with the roster over rotations.",
  ...
  rivalCounter: {
    ...
    responseRound: {
      id: "rival-response",
      prompt: "The media narrative is now about analytics adoption. How does your team respond publicly?",
      options: [
        {
          id: "own-the-narrative",
          label: "Lean in. position the team as analytics-forward in media",
  ...
  outcomes: [
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 3,
          narrative:
            "Finished 3 games below .500. The analytics team ran the counterfactual. the bench lineup, used properly, projects to 5-6 extra wins. That's the difference between a lottery pick and a playoff run. The data was right. You didn't act on it.",
          applyStatus: ["coach-conflict"],
        },
      ],
    },
    ...
    },
    {
      ...
      variants: [
        {
          probability: 1.0,
          label: "Joint Power — New Organizational Model",
          scoreΔ: 9,
          narrative:
...
const matchupAdjust: Mission = {
  ...
  scenarioInjections: [
    ...
    {
      requiredStatus: "analytics-forward",
      prependText: "Your analytics culture has built trust with the medical team. Their injury models have 94% accuracy on soft tissue risk at this usage level. The data is clear. the question is whether you act on it.",
    },
  ],
  ...
  roles: [
    ...
    },
    {
      ...
      privateInfo:
        "I've had this conversation with DeShawn. He says he's fine. My read. he's competing through discomfort, which is what team players do. What I know is this. if I reduce his minutes and we drop 2 seeds, the fanbase will crucify me. If I play him and he gets hurt, they'll say I should have listened to the doctors. Either way, I need the front office to make this call officially so it doesn't land on me alone. I need air cover.",
    },
    {
      id: "president",
      title: "TEAM PRESIDENT",
      ...
      variants: [
        {
          ...
          scoreΔ: 8,
          narrative:
            "Coach Hill averaged Morris at 33.4 minutes over the last 11 games. Sat him both back-to-backs. Maintained the 4th seed. Morris entered the playoffs at 96% health by physician assessment. The flexibility gave the coach power and produced the right outcome.",
          applyStatus: ["high-morale"],
        },
        {
          probability: 0.40,
      ...
      variants: [
        {
          ...
          scoreΔ: 7,
          narrative:
            "The grade-2 diagnosis was the wake-up call. Three games rest before the playoffs. Morris arrived at 91%. not 100%, but stable. First-round win. The injury scare changed the team's approach to load management permanently.",
          applyStatus: [],
        },
        {
          probability: 0.30,
      ...
      variants: [
        {
          ...
          scoreΔ: 5,
          narrative:
            "He played through it. Grade-2 held. Made it to the playoffs. Won the first round. The medial physician was right about the risk. you got lucky. Morris knows what he put his body through. This conversation will come up in every future contract talks.",
          applyStatus: [],
        },
        {
          probability: 0.70,
...
const draftTable: Mission = {
  ...
  scenarioInjections: [
    ...
    {
      requiredStatus: "analytics-forward",
      prependText: "Your analytics culture has established trust. The model's track record is strong. The question isn't whether to trust data. it's how much you trust it under Draft Night pressure.",
    },
    {
      requiredStatus: "trade-assets-rich",
  ...
  rounds: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          description: "The analytics case is the strongest we've had in years. High swings but top-15 upside.",
...
const finalGmCall: Mission = {
  ...
  scenarioInjections: [
    ...
    {
      requiredStatus: "analytics-forward",
      prependText: "You've built an analytics culture inside this team. Your data infrastructure, your model-driven decisions, your coaching plan. it's all on the line in this room. Defend it or evolve it.",
    },
    {
      requiredStatus: "rebuild-mode",
  ...
  infoCards: [
    ...
    },
    {
      ...
      content:
        "Two rival GMs have been given permission to pursue Webb in a sign-and-trade when his contract expires. One has a war chest of 3 future firsts. Our power. we're the only team that can offer him a supermax extension. $47.6M/year. before he hits free agency. If we extend Webb now at supermax, we control his career for 5 more years. If we let him reach free agency, we lose that power permanently. The owner doesn't know the extension window closes in 60 days.",
      revealDelay: 24,
      roleOnly: "president",
    },
  ],
  ...
  rounds: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          description: "Invest in analytics infrastructure as the primary strong advantage. Fewer emotions, more models.",
      ...
      options: [
        {
          ...
          label: "Analytics and scouting together. parallel tracks, equal power",
        ...
        },
        {
          ...
          description: "Model makes the call. Scouts add human nuance. Analytics leads all major decisions.",
    ...
    responseRound: {
      ...
      options: [
        ...
        },
        {
          ...
          description: "The owner publicly endorses the plan. Front office trust is re-established via his power.",
      ...
      variants: [
        {
          ...
          scoreΔ: 10,
          narrative:
            "The dual-power structure created productive friction. Analytics found two overlooked players. Scouts validated them. Webb was extended and anchored the system. Year 3. 2nd seed in the conference. Two analytically-sourced All-Stars. Zero wasted contracts. This is what a well-run team looks like.",
        ...
        },
        {
          ...
          scoreΔ: 6,
          narrative:
            "Parallel power created paralysis on two key decisions. both scouts and analytics disagreed on the same player, and no one had the power to decide. Missed a deadline. Lost a free agent. Year 3. strong but underachieving for the talent assembled.",
          applyStatus: ["analytics-forward"],
        },
      ],
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          scoreΔ: 5,
          narrative:
            "The primary designation felt like a demotion to the scouting staff. Three elite scouts left within 6 months. The model performed. but lost the human layer that caught non-model risks. One analytics-sourced pick was a character issue that pure metrics couldn't flag.",
          applyStatus: ["analytics-forward", "coach-conflict"],
        },
      ],
    },
      ...
      variants: [
        {
          ...
          scoreΔ: 8,
          narrative:
            "Invested $4M in analytics infrastructure. Replaced two traditional scouts with data scientists. The model found three overlooked players other teams passed on. Year 3. most efficient offense in the league. Webb happy, young core thriving. The scouts who remained became the model's best critics.",
          applyStatus: ["analytics-forward", "high-morale"],
        },
        {
          probability: 0.45,
